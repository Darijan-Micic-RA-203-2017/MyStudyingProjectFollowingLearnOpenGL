...
// Pass the position of light source, the color of light source and the color of object to the fragment shader.
...
void main()
{
	...
	vec3 ambientColor = ambientFactor * colorOfLightSource;
	...
	// 1) addition of ambient's color and diffuse color;
	// 2) object's color.
