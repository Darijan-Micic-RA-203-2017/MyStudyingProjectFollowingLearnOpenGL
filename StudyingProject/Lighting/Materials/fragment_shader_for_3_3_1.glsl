...
void main()
{
	vec3 ambientColor = material.ambientColor * colorOfLightSource;
	...
	vec3 diffuseColor = (diffuseFactor * material.diffuseColor) * colorOfLightSource;
	...
	vec3 specularColor = (specularFactor * material.specularColor) * colorOfLightSource;
