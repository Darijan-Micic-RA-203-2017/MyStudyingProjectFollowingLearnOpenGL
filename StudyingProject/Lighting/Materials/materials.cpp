...
int draw_materials()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		positionOfLightSource_for_3_3_1.x = glm::sin(time) * 2.0f + 1.0f;
		positionOfLightSource_for_3_3_1.y = glm::sin(time / 2.0f);
		*/
	...
	firstMouseEntry_for_3_3_1 = true;
