...
Camera camera_for_3_6_1(glm::vec3(0.0f, 0.0f, 3.0f), glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f));

bool firstMouseEntry_for_3_6_1 = true;
float previousCursorPosX_for_3_6_1 = (float) window_width / 2.0f;
float previousCursorPosY_for_3_6_1 = (float) window_height / 2.0f;
...
float deltaTime_for_3_6_1 = 0.0f;
// The time it took to render the previous frame.
float previousFrameTime_for_3_6_1 = 0.0f;
...
int draw_multiple_lights()
{
	...
	GLFWwindow* window = glfwCreateWindow(window_width, window_height, 
		"Lighting - Multiple lights", NULL, NULL);
	if (window == NULL)
	{
	...
	glfwSetFramebufferSizeCallback(window, framebuffer_size_callback_for_multiple_lights);
	glfwSetCursorPosCallback(window, cursor_pos_callback_for_multiple_lights);
	glfwSetScrollCallback(window, scroll_callback_for_multiple_lights);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		deltaTime_for_3_6_1 = currentFrameTime - previousFrameTime_for_3_6_1;
		previousFrameTime_for_3_6_1 = currentFrameTime;

		// First part: Process the user's input.
		processInput_for_multiple_lights(window);
		...
		*/
		...
		glm::mat4 projectionMatrix = glm::perspective(glm::radians(camera_for_3_6_1.fov), 
		...
		glm::mat4 viewMatrix = camera_for_3_6_1.getCalculatedViewMatrix();
		...
		ourShaderProgram.setFloatVec3Uniform("directionalLightSource.ambientColor", glm::vec3(0.05f, 0.05f, 0.05f));
		ourShaderProgram.setFloatVec3Uniform("directionalLightSource.diffuseColor", glm::vec3(0.4f, 0.4f, 0.4f));
		...
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[0].ambientColor", glm::vec3(0.05f, 0.05f, 0.05f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[0].diffuseColor", glm::vec3(0.8f, 0.8f, 0.8f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[0].specularColor", glm::vec3(1.0f, 1.0f, 1.0f));
		...
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[1].ambientColor", glm::vec3(0.05f, 0.05f, 0.05f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[1].diffuseColor", glm::vec3(0.8f, 0.8f, 0.8f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[1].specularColor", glm::vec3(1.0f, 1.0f, 1.0f));
		...
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[2].ambientColor", glm::vec3(0.05f, 0.05f, 0.05f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[2].diffuseColor", glm::vec3(0.8f, 0.8f, 0.8f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[2].specularColor", glm::vec3(1.0f, 1.0f, 1.0f));
		...
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[3].ambientColor", glm::vec3(0.05f, 0.05f, 0.05f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[3].diffuseColor", glm::vec3(0.8f, 0.8f, 0.8f));
		ourShaderProgram.setFloatVec3Uniform("pointLightSources[3].specularColor", glm::vec3(1.0f, 1.0f, 1.0f));
		...
		ourShaderProgram.setFloatVec3Uniform("spotlight.diffuseColor", glm::vec3(1.0f, 1.0f, 1.0f));
		ourShaderProgram.setFloatVec3Uniform("spotlight.specularColor", glm::vec3(1.0f, 1.0f, 1.0f));
	...
	firstMouseEntry_for_3_6_1 = true;
...
void cursor_pos_callback_for_multiple_lights(GLFWwindow* window, double xpos, double ypos)
{
	...
	if (firstMouseEntry_for_3_6_1)
	{
		previousCursorPosX_for_3_6_1 = xPos;
		previousCursorPosY_for_3_6_1 = yPos;
		firstMouseEntry_for_3_6_1 = false;
	}

	// 1. step: calculate the mouse's offset since last frame.
	float xOffset = xPos - previousCursorPosX_for_3_6_1;
	// Order of subtraction is reversed, because y-coordinates range from bottom to top.
	float yOffset = previousCursorPosY_for_3_6_1 - yPos;
	previousCursorPosX_for_3_6_1 = xPos;
	previousCursorPosY_for_3_6_1 = yPos;

	// 2. step onward: done in Camera class.
	camera_for_3_6_1.processMouseMovement(xOffset, yOffset);
}
...
{
	camera_for_3_6_1.processMouseScroll(static_cast<float>(yoffset));
}
...
void processInput_for_multiple_lights(GLFWwindow* window)
{
	...
	{
		camera_for_3_6_1.processKeyboardInput("W", deltaTime_for_3_6_1);
	}
	if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
	{
		camera_for_3_6_1.processKeyboardInput("S", deltaTime_for_3_6_1);
	}
	if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
	{
		camera_for_3_6_1.processKeyboardInput("A", deltaTime_for_3_6_1);
	}
	if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
	{
		camera_for_3_6_1.processKeyboardInput("D", deltaTime_for_3_6_1);
	}
}
