...
int draw_vezbe_05_zadatak_01()
{
	...
	glfwSetFramebufferSizeCallback(window, framebuffer_size_callback_for_vezbe_05_zadatak_01);
	...
	ShaderProgram shaderProgram("Vezbe_05/Zadatak_01/vertex_shader_for_05_01.glsl", 
		"Vezbe_05/Zadatak_01/fragment_shader_for_05_01.glsl");
...
void processInput_for_vezbe_05_zadatak_01(GLFWwindow* window)
{
