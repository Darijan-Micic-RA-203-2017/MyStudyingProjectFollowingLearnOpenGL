...
#include "Vezbe_05/Zadatak_01/vezbe_05_zadatak_01.h"
#include "Vezbe_06/Zadatak_01/vezbe_06_zadatak_01.h"
...
int main()
{
	...
	while (argument != -1)
	{
		...
		case 8:
			...
			break;
		case 9:
			returnValue = draw_vezbe_05_zadatak_01();
			std::cout << "\"Vežbe 5 - zadatak 1\" exited with return value " 
				<< returnValue << ".\n" << std::endl;
			break;
		case 10:
			returnValue = draw_vezbe_06_zadatak_01();
			std::cout << "\"Vežbe 6 - zadatak 1\" exited with return value " 
				<< returnValue << ".\n" << std::endl;
			break;
		default:
			break;
