...
const char* fragmentShaderSource_for_2_4_3 = "#version 330 core\n\n"
"out vec4 FragColor;\n\n"
"void main()\n"
"{\n"
...
int draw_hello_triangle_exercise1()
{
	...
	GLFWwindow* window = glfwCreateWindow(window_width, window_height, 
		"StudyingProject - Hello Triangle, exercise 1", NULL, NULL);
	if (window == NULL)
	{
	...
	glfwSetFramebufferSizeCallback(window, framebuffer_size_callback_for_hello_triangle_exercise1);
	...
	glShaderSource(vertexShader, 1, &vertexShaderSource_for_2_4_3, NULL);
	...
	glShaderSource(fragmentShader, 1, &fragmentShaderSource_for_2_4_3, NULL);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		processInput_for_hello_triangle_exercise1(window);
...
// Callback function.
void framebuffer_size_callback_for_hello_triangle_exercise1(GLFWwindow* window, int width, int height)
{
	glViewport(0, 0, width, height);
}

// Input processing function.
void processInput_for_hello_triangle_exercise1(GLFWwindow* window)
{
